...
const SidebarHeader = React.forwardRef(({ className, ...props }, ref) => (
  <div ref__={ref} className={cn("px-4 py-4", className)} {...props} />
))
...
const SidebarGroup = React.forwardRef(({ className, ...props }, ref) => (
  <div ref__={ref} className={cn("px-2 py-2", className)} {...props} />
))
SidebarGroup.displayName = "SidebarGroup"

const SidebarGroupLabel = React.forwardRef(({ className, ...props }, ref) => (
  <div ref__={ref} className={cn("px-2 py-1 text-xs font-semibold", className)} {...props} />
))
...
const SidebarMenu = React.forwardRef(({ className, ...props }, ref) => (
  <ul ref__={ref} className={cn("space-y-1", className)} {...props} />
))
SidebarMenu.displayName = "SidebarMenu"

const SidebarMenuItem = React.forwardRef(({ className, ...props }, ref) => (
  <li ref__={ref} className={cn("", className)} {...props} />
))
