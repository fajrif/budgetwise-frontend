...
import { calculateSLAStatus, getSLALabel } from "@/utils/formatters";

export default function PaymentSLAChart({ transactions }) {
  ...
  return (
    <Card className="border-none shadow-lg">
      <CardHeader className="border-b border-slate-100">
        <CardTitle className="text-xl font-bold">Ketepatan Pembayaran</CardTitle>
        <p className="text-sm text-slate-500">Statistik SLA pembayaran berdasarkan tanggal PO/Tagihan</p>
      </CardHeader>
